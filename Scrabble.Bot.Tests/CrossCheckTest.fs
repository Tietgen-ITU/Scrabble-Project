...
let getAllowedLetters_hasARestrictiveMapOnCoord_returnEverything () =
    ...
    let mockState =
        mockState List.empty List.Empty
...
let update_placeCoat_work () =
    ...
    let aTop = "AZTJO" |> Set.ofSeq
    let aBot = "AHSNT" |> Set.ofSeq
    let oTop = "BCDGHJLMNOPSTWY" |> Set.ofSeq
    let oBot = "ADEFO" |> Set.ofSeq
    let cBot = "HO" |> Set.ofSeq
...
let update_placeCoatAndBest_work () =
    ...
    let mockState =
        ...
        |> CrossCheck.update coatMv
        |> State.placeLetters coatMv
        |> CrossCheck.update [ ((1, 1), (0u, ('B', 0)))
                               ((2, 1), (0u, ('E', 0)))
                               ((3, 1), (0u, ('S', 0)))
                               ((4, 1), (0u, ('T', 0))) ]
